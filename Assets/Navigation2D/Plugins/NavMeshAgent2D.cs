...
public class NavMeshAgent2D : MonoBehaviour
{
    ...
    Vector3 teleportPositon;
    public void Teleport(Vector3 positon) {
        teleportPending = true;
        teleportPositon = positon;
    }
    // =============================================
    void Update()
    {
        ...
        if (teleportPending) {
            ...
            agent.transform.position = teleportPositon;
    ...
    public Vector2 destination
    {
        ...
        set
        {
            agent.SetDestination(NavMeshUtils2D.ProjectTo3D(value));
        }
    }
